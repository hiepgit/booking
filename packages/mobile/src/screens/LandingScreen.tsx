      ...
      <View style={styles.backgroundContainer}>
        <View style={styles.photoGrid}>
          ...
          <View style={styles.photoRow}>
            ...
            <PhotoTile
              image={require("../../assets/behnazsabaa_Smiling_Medical_Doctor__Style_of_Her_Film_with_Soft_cabe61f6-0a23-4afa-ace2-90d69e11914f.jpg")}
            />
          ...
          <View style={styles.photoRow}>
            <PhotoTile
              image={require("../../assets/behnazsabaa_Portrait_of_Smiling_Male_Medical_Doctor__Style_of_H_0996798e-acc5-48e2-9b18-79c922a9f29b.jpg")}
            />
            ...
            <PhotoTile
              image={require("../../assets/behnazsabaa_Smiling_Medical_Doctor__Style_of_Her_Film_with_Soft_0018eb0f-c5eb-48db-9994-918bde9cd9d4.jpg")}
            />
          </View>
